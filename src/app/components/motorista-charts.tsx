        ...
        <div className="h-[180px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartDeliveries} margin={{ top: 5, right: 5, left: -15, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="ganhos" name="Ganhos" stroke="#ff00ff" strokeWidth={2} fill="url(#gradMotoristaGanhos)"
        ...
        <div className="h-[180px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartDeliveries} margin={{ top: 5, right: 5, left: -15, bottom: 0 }}>
              ...
              <Tooltip content={<NeonTooltip />} />
              <Bar dataKey="entregas" name="Entregas" fill="#00f0ff" radius={[4, 4, 0, 0]} maxBarSize={30} />
            </BarChart>
          </ResponsiveContainer>
        </div>
        {!hasData && (
